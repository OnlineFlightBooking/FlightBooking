...
namespace FLightBookingSystem.Controllers.Admin
{
    public class CustomersController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            DatabaseLayer.Customer customer = db.Customers.Find(id);
            if (customer == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create([Bind(Include = "ID,Name,EmailAddress,MobileNo,Password,IsAdmin,DOB,CIty,AdharCard,Gender")] DatabaseLayer.Customer customer)
        {
